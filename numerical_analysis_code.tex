...
*/
\end{lstlisting}
\includegraphics[width=0.8\textwidth]{screenshots/7.png}
...
*/
\end{lstlisting}
\includegraphics[width=0.8\textwidth]{screenshots/8.png}
...
*/
\end{lstlisting}
\includegraphics[width=0.8\textwidth]{screenshots/9.png}
...
*/
\end{lstlisting}
\includegraphics[width=0.8\textwidth]{screenshots/10.png}
